...
const TRANSLATIONS = {
  fr: {
    ...
    description: 'Découvrez les meilleurs restaurants, lieux secrets et histoires locales grâce à notre IA.',
  ...
  en: {
    ...
    description: 'Discover the best restaurants, secret spots, and local stories with our AI.',
  ...
  it: {
    ...
    description: 'Scopri i migliori ristoranti, luoghi segreti e storie locali grazie alla nostra IA.',
    botCardTitle: '🤖 Chatbot Telegram',
  ...
  de: {
    ...
    description: 'Entdecken Sie die besten Restaurants, geheimen Orte und lokalen Geschichten mit unserer KI.',
    botCardTitle: '🤖 Telegram Chatbot',
  ...
  es: {
    ...
    description: 'Descubre los mejores restaurantes, lugares secretos e historias locales con nuestra IA.',
    botCardTitle: '🤖 Chatbot Telegram',
      ...
      <main className="max-w-4xl w-full text-center space-y-8 mt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-lg mx-auto mt-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-100 hover:shadow-xl transition-shadow">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">{t.botCardTitle}</h2>
          ...
          {/* Dashboard Card */}
          <div className="bg-white p-6 rounded-xl shadow-lg border border-blue-100 hover:shadow-xl transition-shadow">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">{t.dashCardTitle}</h2>
